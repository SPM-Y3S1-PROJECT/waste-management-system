...
export default function Category() {
  ...
  async function removeCatogeryInfo(id) {
    try {
      ...
      await axios.delete(`http://localhost:9090/Category/delete/${id}`).then((response) => {
        ...
        toast.success("Successfully delete info!", {
  ...
  function sendData(e) {
    ...
    if (Categoryname.length == 0) {
      toast.error("please fill form  info !", {
        position: toast.POSITION.TOP_RIGHT
      });
      setError(true);
    }
    ...
    axios.post("http://localhost:9090/Category/add", newCat).then(() => {
      // alert("Category add");
      toast.success("Successfully add Category info !", {
        position: toast.POSITION.TOP_RIGHT
      ...
      <div className="main-wrapper">
        ...
        <div className="container-fluid">
          <div className="card shadow mb-4">
            ...
            <table className="table table-bordered table-responsive-md table-hover ">
